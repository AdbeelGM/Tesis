...
const LEARN_UNITS = [
  {
    eyebrow: 'Sección 1',
    title: 'Bases de LSM',
    subtitle: 'Letras y números: precisión visual antes de vocabulario largo.',
    levels: [1, 2],
    offsets: [90, -80],
  },
  {
    ...
    subtitle: 'Saluda, nombra personas cercanas y describe ropa o colores.',
    levels: [3, 4, 5],
    offsets: [0, 100, -60],
  },
  {
    eyebrow: 'Sección 3',
    title: 'Tiempo, lugares y movimiento',
    subtitle: 'Ubica cuándo sucede algo y cómo llegar a un destino.',
    levels: [6, 7],
    offsets: [-70, 85],
  },
  {
    eyebrow: 'Sección 4',
    title: 'Vida diaria y seguridad',
    subtitle: 'Practica profesiones, salud, emergencias y tecnología con intención práctica.',
    levels: [8, 9, 10, 11],
    offsets: [-15, 95, -55, 80],
  },
  {
    eyebrow: 'Sección 5',
    title: 'Cultura, ciudadanía y repaso',
    subtitle: 'Avanza a arte, jurídico, historia y un cierre integrador con propósito comunicativo.',
    levels: [12, 13, 14, 15],
    offsets: [-90, 10, 100, -65],
  },
];
